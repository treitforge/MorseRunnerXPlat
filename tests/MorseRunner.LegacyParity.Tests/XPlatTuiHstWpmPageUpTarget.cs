...
public sealed class XPlatTuiHstWpmPageUpTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-TUI-WPM-HST-page-up-rounding-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        TuiHstWpmPageUpInput input = TuiHstWpmPageUpInput.Parse(scenario);
...
internal sealed record TuiHstWpmPageUpInput(
    int Seed,
    int ExpectedAfterWpm,
    int InitialWpm,
    string RunModeId)
{
    public static TuiHstWpmPageUpInput Parse(ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new TuiHstWpmPageUpInput(
