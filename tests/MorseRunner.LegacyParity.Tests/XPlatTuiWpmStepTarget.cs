...
public sealed class XPlatTuiWpmStepTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-TUI-WPM-default-page-up-step-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        TuiWpmStepInput input = TuiWpmStepInput.Parse(scenario);
...
internal sealed record TuiWpmStepInput(
    int Seed,
    int DefaultWpmStep,
    ...
    string RunModeId)
{
    public static TuiWpmStepInput Parse(ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new TuiWpmStepInput(
