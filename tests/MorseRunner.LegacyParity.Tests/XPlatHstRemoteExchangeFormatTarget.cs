...
public sealed class XPlatHstRemoteExchangeFormatTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "contest-hst-remote-exchange-format-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        HstRemoteExchangeFormatInput input =
            HstRemoteExchangeFormatInput.Parse(scenario);
    ...
    internal static string[] Observe(HstRemoteExchangeFormatInput input)
    {
...
internal sealed record HstRemoteExchangeFormatInput(
    string ContestId,
    string RunModeId,
    string StationCall,
    string RemoteCall,
    ...
    int Seed)
{
    public static HstRemoteExchangeFormatInput Parse(ParityScenario scenario)
    {
        ...
        var result = new HstRemoteExchangeFormatInput(
        ...
        string discriminator = RequireString(
            ...
            "scenario",
            scenario.Id);
        if (discriminator != XPlatHstRemoteExchangeFormatTarget.ParityId
            || result.ContestId != "scHst"
