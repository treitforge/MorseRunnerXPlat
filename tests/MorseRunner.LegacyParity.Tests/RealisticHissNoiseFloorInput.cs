...
internal sealed record RealisticHissNoiseFloorInput(
    int SampleRate,
    int BlockSize,
    int Seed,
    int BandwidthHz,
...
{
    internal const int ExpectedValueCount = 14;
    ...
    public static RealisticHissNoiseFloorInput Parse(
        ParityScenario scenario)
    {
        ...
        {
            throw new InvalidDataException(
                $"Parity case '{scenario.Id}' realistic hiss input is "
                + "invalid.");
        }
