...
public sealed class XPlatNaqpRemoteExchangeFormatTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "contest-naqp-remote-exchange-format-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        NaqpRemoteExchangeFormatInput input =
            NaqpRemoteExchangeFormatInput.Parse(scenario);
    ...
    internal static string[] Observe(NaqpRemoteExchangeFormatInput input)
    {
...
internal sealed record NaqpRemoteExchangeFormatInput(
    string ContestId,
    string RunModeId,
    string StationCall,
    string RemoteCall,
    ...
    int Seed)
{
    public static NaqpRemoteExchangeFormatInput Parse(ParityScenario scenario)
    {
        ...
        var result = new NaqpRemoteExchangeFormatInput(
        ...
        string discriminator = RequireString(
            ...
            "scenario",
            scenario.Id);
        if (discriminator != XPlatNaqpRemoteExchangeFormatTarget.ParityId
            || result.ContestId != "scNaQp"
