...
public sealed class XPlatAvaloniaHstWpmPageUpTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-WPM-HST-page-up-rounding-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        AvaloniaHstWpmPageUpInput input =
            AvaloniaHstWpmPageUpInput.Parse(scenario);
...
internal sealed record AvaloniaHstWpmPageUpInput(
    int Seed,
    int ExpectedAfterWpm,
    int InitialWpm,
    string RunModeId)
{
    public static AvaloniaHstWpmPageUpInput Parse(ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new AvaloniaHstWpmPageUpInput(
        ...
        if (!actualNames.SequenceEqual(expectedNames, StringComparer.Ordinal)
            ...
            || result.Seed != 12_345
            || result.ExpectedAfterWpm != 35
            || result.InitialWpm != 32
