...
public sealed class XPlatSstRemoteExchangeFormatTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "contest-sst-remote-exchange-format-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        SstRemoteExchangeFormatInput input =
            SstRemoteExchangeFormatInput.Parse(scenario);
...
internal sealed record SstRemoteExchangeFormatInput(
    string ContestId,
    string RunModeId,
    string StationCall,
    string RemoteCall,
    ...
    int Seed)
{
    public static SstRemoteExchangeFormatInput Parse(
        ParityScenario scenario)
    {
        ...
        var result = new SstRemoteExchangeFormatInput(
