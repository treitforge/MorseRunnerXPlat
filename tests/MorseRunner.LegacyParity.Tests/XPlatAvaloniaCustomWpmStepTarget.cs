...
public sealed class XPlatAvaloniaCustomWpmStepTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-WPM-custom-page-up-step-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        AvaloniaCustomWpmStepInput input =
            AvaloniaCustomWpmStepInput.Parse(scenario);
...
internal sealed record AvaloniaCustomWpmStepInput(
    int Seed,
    int CustomWpmStep,
    ...
    string RunModeId)
{
    public static AvaloniaCustomWpmStepInput Parse(ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new AvaloniaCustomWpmStepInput(
