...
public sealed class XPlatSweepstakesRemoteExchangeFormatTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "contest-sweepstakes-remote-exchange-format-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        SweepstakesRemoteExchangeFormatInput input =
            SweepstakesRemoteExchangeFormatInput.Parse(scenario);
...
internal sealed record SweepstakesRemoteExchangeFormatInput(
    string ContestId,
    string RunModeId,
    string StationCall,
    string RemoteCall,
    ...
    int Seed)
{
    public static SweepstakesRemoteExchangeFormatInput Parse(
        ParityScenario scenario)
    {
        ...
        var result = new SweepstakesRemoteExchangeFormatInput(
