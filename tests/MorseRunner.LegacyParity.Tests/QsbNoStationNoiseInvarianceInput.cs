...
internal sealed record QsbNoStationNoiseInvarianceInput(
    int SampleRate,
    int BlockSize,
    int Seed,
    int BandwidthHz,
    ...
    IReadOnlyList<int> ProbeSampleIndexes)
{
    ...
    public static QsbNoStationNoiseInvarianceInput Parse(
        ParityScenario scenario)
    {
        ...
        {
            throw new InvalidDataException(
                $"Parity case '{scenario.Id}' QSB no-station input is "
                + "invalid.");
        }
