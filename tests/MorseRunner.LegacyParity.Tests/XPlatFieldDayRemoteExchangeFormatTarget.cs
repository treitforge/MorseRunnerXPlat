...
public sealed class XPlatFieldDayRemoteExchangeFormatTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "contest-fieldday-remote-exchange-format-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        FieldDayRemoteExchangeFormatInput input =
            FieldDayRemoteExchangeFormatInput.Parse(scenario);
...
internal sealed record FieldDayRemoteExchangeFormatInput(
    string ContestId,
    string RunModeId,
    string StationCall,
    string RemoteCall,
    ...
    int Seed)
{
    public static FieldDayRemoteExchangeFormatInput Parse(
        ParityScenario scenario)
    {
        ...
        var result = new FieldDayRemoteExchangeFormatInput(
