...
public sealed class XPlatAvaloniaWpmStepUpperClampTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-WPM-step-upper-clamp-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        AvaloniaWpmStepUpperClampInput input =
            AvaloniaWpmStepUpperClampInput.Parse(scenario);
...
internal sealed record AvaloniaWpmStepUpperClampInput(
    int Seed,
    ...
    string RunModeId)
{
    public static AvaloniaWpmStepUpperClampInput Parse(
        ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new AvaloniaWpmStepUpperClampInput(
