...
public sealed class XPlatTuiCustomWpmStepTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-TUI-WPM-custom-page-up-step-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        TuiCustomWpmStepInput input = TuiCustomWpmStepInput.Parse(scenario);
...
internal sealed record TuiCustomWpmStepInput(
    int Seed,
    int CustomWpmStep,
    ...
    string RunModeId)
{
    public static TuiCustomWpmStepInput Parse(ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new TuiCustomWpmStepInput(
