...
public sealed class XPlatTuiWpmStepLowerClampTarget : IParityTarget
{
    ...
    internal const string FunctionalDivergenceCode =
        "ux-TUI-WPM-step-lower-clamp-mismatch";
        ...
        CancellationToken cancellationToken)
    {
        ...
        TuiWpmStepLowerClampInput input =
            TuiWpmStepLowerClampInput.Parse(scenario);
...
internal sealed record TuiWpmStepLowerClampInput(
    int Seed,
    ...
    string RunModeId)
{
    public static TuiWpmStepLowerClampInput Parse(ParityScenario scenario)
    {
        ...
        string[] actualNames = input
            ...
            .ToArray();
        var result = new TuiWpmStepLowerClampInput(
