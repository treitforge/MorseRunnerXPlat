...
internal sealed record FlutterNoStationNoiseInvarianceInput(
    int SampleRate,
    int BlockSize,
    int Seed,
    int BandwidthHz,
...
{
    internal const int ExpectedValueCount = 8;
    ...
    public static FlutterNoStationNoiseInvarianceInput Parse(
        ParityScenario scenario)
    {
        ...
        {
            throw new InvalidDataException(
                $"Parity case '{scenario.Id}' flutter no-station input is "
                + "invalid.");
        }
