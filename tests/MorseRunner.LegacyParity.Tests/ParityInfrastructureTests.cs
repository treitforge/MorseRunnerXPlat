...
public sealed class ParityInfrastructureTests
{
    ...
    public void CaseIdSelectsItsExactXPlatAdapter()
    {
        ...
        Assert.IsType<XPlatTuiRitUpStepTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-rit-default-up-command-step-50-hz-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatTuiWpmSetupUpperRangeTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-setup-upper-range-increment-from-100"
                    + "-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        ...
        Assert.IsType<XPlatTuiHstWpmPageDownTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-hst-page-down-rounds-33-to-30-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatTuiCustomWpmStepTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-custom-page-up-command-step-7-wpm-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatTuiCustomWpmPageDownTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-custom-page-down-command-step-7-wpm-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatTuiWpmStepLowerClampTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-step-lower-clamp-page-up-from-zero-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatTuiWpmStepUpperClampTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-step-upper-clamp-page-up-from-21-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaCustomWpmStepTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.wpm-custom-page-up-command-step-7-wpm-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaCustomWpmPageDownTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.wpm-custom-page-down-command-step-7-wpm-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaWpmStepLowerClampTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.wpm-step-lower-clamp-page-up-from-zero-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaWpmStepUpperClampTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.wpm-step-upper-clamp-page-up-from-21-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatTuiWpmSetupLowerClampTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.tui-wpm-setup-lower-clamp-decrement-from-10"
                    + "-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaWpmStepTarget>(
            ParityAcceptanceRegistry
                .Get(
                    "ux.wpm-default-page-up-command-step-2-wpm-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaHstWpmPageUpTarget>(
            ParityAcceptanceRegistry
                ...
                .CreateTarget(ParityTargetKind.XPlat)());
        Assert.IsType<XPlatAvaloniaHstWpmPageDownTarget>(
            ParityAcceptanceRegistry
                .Get("ux.wpm-hst-page-down-rounds-33-to-30-seed-12345")
                .CreateTarget(ParityTargetKind.XPlat)());
    }
