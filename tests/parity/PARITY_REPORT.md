...
- Overlapping case surface/platform assignments: 303
...
- Active acceptance cases: 47
- Evidence-certified both-green cases: 0
- Legacy-green/XPlat-red cases: 47
...
| `ux.main-form-events` | Legacy main-form event bindings and handlers | `not-authored` | 0 | 229 | 21 | `Main.dfm:1-1988`<br>`Main.pas:452-2867` |
| `ux.keyboard-workflows` | Legacy shortcuts and keyboard branches | `partial` | 9 | 53 | 0 | `Main.dfm:1000-1579`<br>`Main.pas:629-947` |
...
| `ux.wpm-hst-five-wpm-rounding` | `ux.keyboard-workflows` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | HST PageUp and PageDown workflows round CW speed outward to CE's adjacent five-WPM boundary. |
