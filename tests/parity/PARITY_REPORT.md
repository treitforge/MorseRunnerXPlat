...
- Overlapping case surface/platform assignments: 444
...
- Active acceptance cases: 72
- Evidence-certified both-green cases: 0
- Legacy-green/XPlat-red cases: 72
...
| `configuration.persisted-settings` | Legacy persisted settings | `partial` | 6 | 60 | 102 | `Ini.pas:345-548` |
...
| `ux.legacy-form-definitions` | Legacy Lazarus and Delphi form definitions | `not-authored` | 0 | 410 | 6 | `Main.lfm`<br>`Main.pas`<br>`ScoreDlg.dfm`<br>`ScoreDlg.lfm`<br>`ScoreDlg.pas` |
...
| `audio.rit-affects-rendered-stations` | `audio-dsp.legacy-processing` | `bound` | `partial` | 2 | `windows`, `linux`, `macos` | RIT changes each station's audible offset using CE range, steps, and block-boundary timing. |
| `audio.runtime-bandwidth-updates-filters` | `audio-dsp.legacy-processing` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | Runtime bandwidth changes replace or update receiver filters at the CE-equivalent block boundary. |
...
| `audio.qsb-independent-per-station` | `simulation.legacy-effects` | `bound` | `partial` | 2 | `windows`, `linux`, `macos` | Every remote station has an independent CE-distributed QSB process without fading the receiver noise floor. |
...
| `audio.single-seeded-random-stream` | `simulation.legacy-effects` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | One seeded session random stream reproduces CE ownership and cross-feature draw order. |
...
| `contest.allja-acag-truth-column-mapping` | `contest.legacy-implementations` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | ALLJA and ACAG station truth use the correct CE data columns without serial fallback. |
...
| `ux.rit-wpm-bandwidth-ranges-and-steps` | `ux.keyboard-workflows` | `bound` | `partial` | 2 | `windows`, `linux`, `macos` | RIT, WPM, and bandwidth ranges, increments, clamping, and displayed engine state match CE. |
...
| `settings.production-startup-legacy-import` | `configuration.persisted-settings` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | Production startup invokes CE settings migration when appropriate. |
| `settings.ce-encoding-semantics` | `configuration.persisted-settings` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | Migration translates CE indexes, ordinals, zero-or-one booleans, IDs, Hz values, duration, block size, and contest exchanges. |
| `settings.preserve-unknown-and-unconsumed-values` | `configuration.persisted-settings` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | Migration and save preserve unknown or unconsumed CE values and are idempotent. |
...
| `settings.all-supported-ce-keys-consumed-or-preserved` | `configuration.persisted-settings` | `bound` | `partial` | 1 | `windows`, `linux`, `macos` | Every supported CE key is consumed with equivalent semantics or preserved losslessly across import, save, and restart. |
...
| `ux.wpm-hst-five-wpm-rounding` | `ux.keyboard-workflows` | `bound` | `partial` | 4 | `windows`, `linux`, `macos` | HST PageUp and PageDown workflows round CW speed outward to CE's adjacent five-WPM boundary. |
...
|---|---|---|---|---|---|---|
| `audio.bandwidth-runtime-narrow-second-cq-block-seed-12345` | `audio-dsp.legacy-processing` | `audio.runtime-bandwidth-updates-filters` | `legacy-green-xplat-red` | `audio-runtime-bandwidth-change-mismatch` | `pass` | `fail` |
...
| `audio.qrm-caller-collision-retry-limit-seed-24680` | `simulation.legacy-effects` | `audio.qrm-interfering-cw-stations` | `legacy-green-xplat-red` | `audio-qrm-caller-collision-retry-limit-mismatch` | `pass` | `fail` |
...
| `engine.contest-specific-cq-tu-station-id-seed-12345` | `contest.legacy-implementations` | `engine.contest-specific-cq-tu-and-station-id` | `legacy-green-xplat-red` | `engine-contest-specific-cq-tu-station-id-mismatch` | `pass` | `fail` |
...
| `audio.rit-runtime-plus-50-second-caller-block-seed-12345` | `audio-dsp.legacy-processing` | `audio.rit-affects-rendered-stations` | `legacy-green-xplat-red` | `audio-runtime-RIT-change-mismatch` | `pass` | `fail` |
| `audio.rit-upper-clamp-extra-click-second-caller-block-seed-12345` | `audio-dsp.legacy-processing` | `audio.rit-affects-rendered-stations` | `legacy-green-xplat-red` | `audio-RIT-upper-clamp-mismatch` | `pass` | `fail` |
...
| `contest.default-two-field-remote-exchange-format-seed-12345` | `contest.legacy-implementations` | `contest.full-remote-exchange-formatting` | `legacy-green-xplat-red` | `contest-default-two-field-remote-exchange-format-mismatch` | `pass` | `fail` |
...
| `contest.sst-remote-exchange-format-seed-12345` | `contest.legacy-implementations` | `contest.full-remote-exchange-formatting` | `legacy-green-xplat-red` | `contest-sst-remote-exchange-format-mismatch` | `pass` | `fail` |
| `contest.sweepstakes-remote-exchange-format-seed-12345` | `contest.legacy-implementations` | `contest.full-remote-exchange-formatting` | `legacy-green-xplat-red` | `contest-sweepstakes-remote-exchange-format-mismatch` | `pass` | `fail` |
...
| `ux.tui-wpm-hst-page-down-rounds-33-to-30-seed-12345` | `ux.keyboard-workflows` | `ux.wpm-hst-five-wpm-rounding` | `legacy-green-xplat-red` | `ux-TUI-WPM-HST-page-down-rounding-mismatch` | `pass` | `fail` |
| `ux.wpm-custom-page-up-command-step-7-wpm-seed-12345` | `ux.keyboard-workflows` | `ux.wpm-default-page-up-step` | `legacy-green-xplat-red` | `ux-WPM-custom-page-up-step-mismatch` | `pass` | `fail` |
| `ux.tui-wpm-custom-page-up-command-step-7-wpm-seed-12345` | `ux.keyboard-workflows` | `ux.wpm-default-page-up-step` | `legacy-green-xplat-red` | `ux-TUI-WPM-custom-page-up-step-mismatch` | `pass` | `fail` |
| `ux.wpm-custom-page-down-command-step-7-wpm-seed-12345` | `ux.keyboard-workflows` | `ux.wpm-default-page-up-step` | `legacy-green-xplat-red` | `ux-WPM-custom-page-down-step-mismatch` | `pass` | `fail` |
| `ux.tui-wpm-custom-page-down-command-step-7-wpm-seed-12345` | `ux.keyboard-workflows` | `ux.wpm-default-page-up-step` | `legacy-green-xplat-red` | `ux-TUI-WPM-custom-page-down-step-mismatch` | `pass` | `fail` |
| `ux.wpm-step-lower-clamp-page-up-from-zero-seed-12345` | `ux.keyboard-workflows` | `ux.wpm-default-page-up-step` | `legacy-green-xplat-red` | `ux-WPM-step-lower-clamp-mismatch` | `pass` | `fail` |
...
| `settings.ce-encoding-translation` | `configuration.persisted-settings` | `settings.ce-encoding-semantics` | `legacy-green-xplat-red` | `settings-ce-encoding-translation-mismatch` | `pass` | `fail` |
| `settings.production-legacy-import` | `configuration.persisted-settings` | `settings.production-startup-legacy-import` | `legacy-green-xplat-red` | `settings-production-legacy-import-mismatch` | `pass` | `fail` |
