...
- Overlapping case surface/platform assignments: 81
...
- Source-bound obligations: 13
- Pending source bindings: 106
- Complete obligations: 0
- Partially authored obligations: 13
- Not-authored obligations: 106
- Rich-artifact evidence blockers: 0
- Active acceptance cases: 17
- Evidence-certified both-green cases: 0
- Legacy-green/XPlat-red cases: 17
...
| `simulation.runtime-routines` | Legacy contest, station, and operator routines | `partial` | 1 | 93 | 75 | `Contest.pas`<br>`Station.pas`<br>`DxOper.pas`<br>`DxStn.pas`<br>`StnColl.pas`<br>`MyStn.pas`<br>`QrmStn.pas`<br>`QrnStn.pas` |
...
| `contest.legacy-implementations` | Legacy contest-specific implementations | `partial` | 2 | 215 | 0 | `ACAG.pas`<br>`ALLJA.pas`<br>`ArrlDx.pas`<br>`ArrlFd.pas`<br>`ArrlSS.pas`<br>`CqWpx.pas`<br>`CqWW.pas`<br>`CWOPS.pas`<br>`CWSST.pas`<br>`DualExchContest.pas`<br>`IaruHf.pas`<br>`NaQp.pas` |
