...
- Overlapping case surface/platform assignments: 207
...
- Source-bound obligations: 16
- Pending source bindings: 103
- Complete obligations: 0
- Partially authored obligations: 16
- Not-authored obligations: 103
- Rich-artifact evidence blockers: 0
- Active acceptance cases: 33
- Evidence-certified both-green cases: 0
- Legacy-green/XPlat-red cases: 33
...
| `simulation.runtime-routines` | Legacy contest, station, and operator routines | `partial` | 1 | 93 | 201 | `Contest.pas`<br>`Station.pas`<br>`DxOper.pas`<br>`DxStn.pas`<br>`StnColl.pas`<br>`MyStn.pas`<br>`QrmStn.pas`<br>`QrnStn.pas` |
| `audio-dsp.legacy-processing` | Legacy portable keying and DSP processing | `partial` | 4 | 131 | 0 | `VCL/Crc32.pas`<br>`VCL/FarnsKeyer.pas`<br>`VCL/Mixers.pas`<br>`VCL/MorseKey.pas`<br>`VCL/MorseTbl.pas`<br>`VCL/MovAvg.pas`<br>`VCL/QuickAvg.pas`<br>`VCL/SndTypes.pas`<br>`VCL/VolumCtl.pas` |
