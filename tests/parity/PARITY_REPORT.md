...
- Overlapping case surface/platform assignments: 300
...
| `ux.keyboard-workflows` | Legacy shortcuts and keyboard branches | `partial` | 8 | 53 | 0 | `Main.dfm:1000-1579`<br>`Main.pas:629-947` |
