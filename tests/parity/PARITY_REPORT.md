...
- Overlapping case surface/platform assignments: 312
...
- Active acceptance cases: 50
- Evidence-certified both-green cases: 0
- Legacy-green/XPlat-red cases: 50
...
| `ux.main-form-events` | Legacy main-form event bindings and handlers | `not-authored` | 0 | 229 | 30 | `Main.dfm:1-1988`<br>`Main.pas:452-2867` |
| `ux.keyboard-workflows` | Legacy shortcuts and keyboard branches | `partial` | 12 | 53 | 0 | `Main.dfm:1000-1579`<br>`Main.pas:629-947` |
