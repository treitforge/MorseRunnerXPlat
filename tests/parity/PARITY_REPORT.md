...
- Overlapping case surface/platform assignments: 6
...
- Source-bound obligations: 6
- Pending source bindings: 113
- Complete obligations: 0
- Partially authored obligations: 6
- Not-authored obligations: 113
- Rich-artifact evidence blockers: 0
- Active acceptance cases: 6
- Evidence-certified both-green cases: 0
- Legacy-green/XPlat-red cases: 6
...
| `simulation.runtime-routines` | Legacy contest, station, and operator routines | `not-authored` | 0 | 93 | 6 | `Contest.pas`<br>`Station.pas`<br>`DxOper.pas`<br>`DxStn.pas`<br>`StnColl.pas`<br>`MyStn.pas`<br>`QrmStn.pas`<br>`QrnStn.pas` |
