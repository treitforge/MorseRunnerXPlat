...
{$ifndef V74_PRODUCTION_LEGACY_IMPORT}
  {$fatal V74_PRODUCTION_LEGACY_IMPORT must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v74';
  ExpectedSource =
    'tests/parity/legacy-oracle/v74/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v74/build-recipe.json';
  ExpectedScenario = 'settings.production-legacy-import';
...
begin
  ...
  try
    ...
    ObserveProductionLegacyImport(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
