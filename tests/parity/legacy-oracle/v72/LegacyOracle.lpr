...
{$ifndef V72_CLEAN_PROFILE_DEFAULTS}
  {$fatal V72_CLEAN_PROFILE_DEFAULTS must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v72';
  ExpectedSource =
    'tests/parity/legacy-oracle/v72/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v72/build-recipe.json';
  ExpectedScenario = 'settings.clean-profile-ce-defaults';
...
begin
  ...
  try
    ...
    ObserveCleanProfileDefaults(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
