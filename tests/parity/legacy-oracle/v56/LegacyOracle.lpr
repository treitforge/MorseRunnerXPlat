...
{$ifndef V56_TUI_CUSTOM_WPM_STEP}
  {$fatal V56_TUI_CUSTOM_WPM_STEP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v56';
  ExpectedSource =
    'tests/parity/legacy-oracle/v56/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v56/build-recipe.json';
  ExpectedScenario =
