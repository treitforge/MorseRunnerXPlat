...
{$ifndef V43_RIT_UPPER_CLAMP}
  {$fatal V43_RIT_UPPER_CLAMP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v43';
  ExpectedSource =
    'tests/parity/legacy-oracle/v43/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v43/build-recipe.json';
  ExpectedScenario =
