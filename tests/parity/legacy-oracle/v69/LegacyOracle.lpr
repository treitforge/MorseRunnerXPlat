...
{$ifndef V69_DURATION_RANGE}
  {$fatal V69_DURATION_RANGE must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v69';
  ExpectedSource =
    'tests/parity/legacy-oracle/v69/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v69/build-recipe.json';
  ExpectedScenario = 'settings.duration-full-range';
...
begin
  ...
  try
    ...
    ObserveDurationRange(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
