...
{$ifndef V62_TUI_WPM_STEP_UPPER_CLAMP}
  {$fatal V62_TUI_WPM_STEP_UPPER_CLAMP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v62';
  ExpectedSource =
    'tests/parity/legacy-oracle/v62/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v62/build-recipe.json';
  ExpectedScenario =
