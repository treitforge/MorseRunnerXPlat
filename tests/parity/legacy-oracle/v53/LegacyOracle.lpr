...
{$ifndef V53_HST_WPM_PAGE_DOWN_ROUNDING}
  {$fatal V53_HST_WPM_PAGE_DOWN_ROUNDING must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v53';
  ExpectedSource =
    'tests/parity/legacy-oracle/v53/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v53/build-recipe.json';
  ExpectedScenario =
