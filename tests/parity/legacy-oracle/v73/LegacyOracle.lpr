...
{$ifndef V73_CE_ENCODING_TRANSLATION}
  {$fatal V73_CE_ENCODING_TRANSLATION must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v73';
  ExpectedSource =
    'tests/parity/legacy-oracle/v73/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v73/build-recipe.json';
  ExpectedScenario = 'settings.ce-encoding-translation';
...
begin
  ...
  try
    ...
    ObserveCeEncodingTranslation(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
