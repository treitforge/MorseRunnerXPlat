...
{$ifndef V46_WPM_DEFAULT_PAGE_UP_STEP}
  {$fatal V46_WPM_DEFAULT_PAGE_UP_STEP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v46';
  ExpectedSource =
    'tests/parity/legacy-oracle/v46/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v46/build-recipe.json';
  ExpectedScenario =
