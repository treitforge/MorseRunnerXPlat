...
{$ifndef V48_WPM_UPPER_CLAMP}
  {$fatal V48_WPM_UPPER_CLAMP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v48';
  ExpectedSource =
    'tests/parity/legacy-oracle/v48/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v48/build-recipe.json';
  ExpectedScenario =
...
begin
  ...
  try
    ...
    ObserveWpmUpperClamp(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
