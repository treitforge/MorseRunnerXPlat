...
{$ifndef V59_AVALONIA_WPM_STEP_LOWER_CLAMP}
  {$fatal V59_AVALONIA_WPM_STEP_LOWER_CLAMP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v59';
  ExpectedSource =
    'tests/parity/legacy-oracle/v59/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v59/build-recipe.json';
  ExpectedScenario =
