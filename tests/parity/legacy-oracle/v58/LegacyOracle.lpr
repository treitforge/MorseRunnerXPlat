...
{$ifndef V58_TUI_CUSTOM_WPM_PAGE_DOWN}
  {$fatal V58_TUI_CUSTOM_WPM_PAGE_DOWN must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v58';
  ExpectedSource =
    'tests/parity/legacy-oracle/v58/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v58/build-recipe.json';
  ExpectedScenario =
