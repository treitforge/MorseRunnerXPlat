...
{$ifndef V51_HST_WPM_PAGE_UP_ROUNDING}
  {$fatal V51_HST_WPM_PAGE_UP_ROUNDING must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v51';
  ExpectedSource =
    'tests/parity/legacy-oracle/v51/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v51/build-recipe.json';
  ExpectedScenario =
