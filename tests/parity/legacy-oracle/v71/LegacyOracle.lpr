...
{$ifndef V71_COMPETITION_FORCED_SETTINGS}
  {$fatal V71_COMPETITION_FORCED_SETTINGS must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v71';
  ExpectedSource =
    'tests/parity/legacy-oracle/v71/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v71/build-recipe.json';
  ExpectedScenario = 'session.competition-forced-settings';
...
begin
  ...
  try
    ...
    ObserveCompetitionForcedSettings(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
