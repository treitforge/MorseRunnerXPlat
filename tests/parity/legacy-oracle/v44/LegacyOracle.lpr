...
{$ifndef V44_RIT_DEFAULT_UP_STEP}
  {$fatal V44_RIT_DEFAULT_UP_STEP must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v44';
  ExpectedSource =
    'tests/parity/legacy-oracle/v44/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v44/build-recipe.json';
  ExpectedScenario =
...
begin
  ...
  if (Seed <> ExpectedSeed)
    ...
    or (ExpectedAfterHz <> ExpectedRitStepHz) then
    raise Exception.Create(
