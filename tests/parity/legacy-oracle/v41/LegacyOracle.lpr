...
{$ifndef V41_RUNTIME_BANDWIDTH_CHANGE}
  {$fatal V41_RUNTIME_BANDWIDTH_CHANGE must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v41';
  ExpectedSource =
    'tests/parity/legacy-oracle/v41/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v41/build-recipe.json';
  ExpectedScenario =
...
begin
  ...
  try
    ...
    ObserveRuntimeBandwidthChange(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
