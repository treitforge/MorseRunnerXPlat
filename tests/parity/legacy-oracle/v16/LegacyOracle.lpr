...
{$ifndef V16_QRM_POSITIVE_STATION}
  {$fatal V16_QRM_POSITIVE_STATION must be defined}
{$endif}
...
const
  ...
  ExpectedVersionId = 'legacy-oracle-v16';
  ExpectedSource =
    'tests/parity/legacy-oracle/v16/LegacyOracle.lpr';
  ExpectedBuildRecipe =
    'tests/parity/legacy-oracle/v16/build-recipe.json';
  ExpectedScenario =
...
begin
  ...
  try
    ...
    ObservePositiveQrm(Values, Input);
    Emit(
      Scenario,
      AdapterId,
      VersionId,
